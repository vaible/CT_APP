...
#Region "Form Event"
    ...
    Private Sub frm生产线查询_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
...
#Region "Button Event"
    ...
    Private Sub btnF2查询_Click(sender As Object, e As EventArgs) Handles btnF2查询.Click
        Try
            ...
            ''検索データ
            mdt = objBll.GetGridData(objM_生产线详细T)
    ...
    Private Sub btnF3选择_Click(sender As Object, e As EventArgs) Handles btnF3选择.Click
        Try
            ...
            mStrCD = grdList.ActiveRow.Cells(col_Gird.生产线编号).Text
            mStr名 = grdList.ActiveRow.Cells(col_Gird.生产线名称).Text
...
#Region "Private Event"
    ...
    Public Sub InitForm()
        ...
        mdt.Columns.Add("生产线编号")
        mdt.Columns.Add("生产线名称")
