...
#Region "Form Event"
    ...
    Private Sub frm部门信息查询_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Public Sub 部门信息查询_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Button Event"
    ...
    Private Sub btnF2查询_Click(sender As Object, e As EventArgs) Handles btnF2查询.Click
        Try
            ...
            ''検索データ
            mdt = objBll.GetGridData(objM_部门详细T)
    ...
    Private Sub btnF3选择_Click(sender As Object, e As EventArgs) Handles btnF3选择.Click
        Try
            ...
            mStrCD = grdList.ActiveRow.Cells(col_Gird.部门编号).Text
            mStr名 = grdList.ActiveRow.Cells(col_Gird.部门名).Text
...
#Region "Private Event"
    ...
    Public Sub SetPermission()
        ...
        '        'F4削除ボタン
        '        btnF4.Enabled = Utility.GetPermission(Constant.cgStrPerm_部门信息查询_削除, Me.Z_DtPermission)

        '        'F6新規ボタン
        '        btnF6.Enabled = Utility.GetPermission(Constant.cgStrPerm_部门信息查询_新規, Me.Z_DtPermission)
