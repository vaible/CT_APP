...
#Region "Form Event"
    ...
    Private Sub frm工程信息查询_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
...
#Region "Button Event"
    ...
    End Sub
     ...
     Private Sub btnF2查询_Click(sender As Object, e As EventArgs) Handles btnF2查询.Click
        Try
            ...
            ''検索データ
            mdt = objBll.GetGridData(objM_工程信息详细T)
    ...
    Private Sub btnF3选择_Click(sender As Object, e As EventArgs) Handles btnF3选择.Click
        Try
            ...
            mStrCD = grdList.ActiveRow.Cells(col_Gird.工程编号).Text
            mStr名 = grdList.ActiveRow.Cells(col_Gird.工程名).Text
...
#Region "Private Event"
    ...
    Public Sub InitForm()
        ...
        mdt.Columns.Add("工程编号")
        mdt.Columns.Add("工程名")
        mdt.Columns.Add("工程类别")
        mdt.Columns.Add("工程类别CD")
