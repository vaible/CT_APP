...
#Region "Form Event"
    ...
    Private Sub frmPDA查询_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
...
#Region "Button Event"
    ...
    Private Sub btnF2查询_Click(sender As Object, e As EventArgs) Handles btnF2查询.Click
        Try
            ...
            ''検索データ
            mdt = objBll.GetGridData(objM_PDA详细T)
    ...
    Private Sub btnF3选择_Click(sender As Object, e As EventArgs) Handles btnF3选择.Click
        Try
            ...
            mStrCD = grdList.ActiveRow.Cells(col_Gird.PDA编号).Text
            mStr名 = grdList.ActiveRow.Cells(col_Gird.PDAIP).Text
...
#Region "Private Event"
    ...
    Public Sub InitForm()
        ...
        mdt.Columns.Add("PDA编号")
        mdt.Columns.Add("PDAIP")
        mdt.Columns.Add("PDA类别")
        mdt.Columns.Add("PDA类别CD")
